<?php /* Smarty version Smarty-3.1.21, created on 2021-06-10 16:51:35
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\addons\components\detailed_page\tabs\addon_update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:40955057260c218e7a41b80-56725679%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b0997e18a9f4f29ac6a27a28b5c3943a4b5e27b3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\views\\addons\\components\\detailed_page\\tabs\\addon_update.tpl',
      1 => 1623227800,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '40955057260c218e7a41b80-56725679',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60c218e7aaa4c1_81175189',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60c218e7aaa4c1_81175189')) {function content_60c218e7aaa4c1_81175189($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\modifier.date_format.php';
?><?php
...
$_tmp4=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'class'=>"btn",'text'=>$_smarty_tpl->__("addons.upgrade_to_version",array("[version]"=>$_smarty_tpl->tpl_vars['actual_change_log']->value['version'])),'href'=>$_tmp4));?>
                        ...
                        <div class="controls">
                            <div class="spaced-child">
                                ...
                                <?php } elseif ($_smarty_tpl->tpl_vars['version_compare']->value<0) {?>
                                    ...
                                    <?php ob_start();
echo htmlspecialchars(fn_url("upgrade_center.manage"), ENT_QUOTES, 'UTF-8');
$_tmp5=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'class'=>"btn",'text'=>$_smarty_tpl->__("addons.upgrade_to_product_version",array("[product]"=>(defined('PRODUCT_NAME') ? constant('PRODUCT_NAME') : null),"[version]"=>$_smarty_tpl->tpl_vars['actual_change_log']->value['compatibility'])),'href'=>$_tmp5));?>
                        ...
                        <div class="controls">
                            <div class="spaced-child">
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['addon']->value['marketplace']['upgrade_available']) {?>
                                    <?php ob_start();
echo htmlspecialchars(fn_url("upgrade_center.manage"), ENT_QUOTES, 'UTF-8');
$_tmp6=ob_get_clean();?><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'class'=>"btn",'text'=>$_smarty_tpl->__("addons.upgrade_to_version",array("[version]"=>$_smarty_tpl->tpl_vars['latest_change_log']->value['version'])),'href'=>$_tmp6));?>
