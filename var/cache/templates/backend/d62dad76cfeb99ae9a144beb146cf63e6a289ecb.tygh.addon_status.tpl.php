<?php /* Smarty version Smarty-3.1.21, created on 2021-06-10 16:51:36
         compiled from "C:\xampp\htdocs\cscart\design\backend\templates\views\addons\components\detailed_page\sidebar\addon_status.tpl" */ ?>
<?php /*%%SmartyHeaderCode:149633887560c218e83db0f8-32848356%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd62dad76cfeb99ae9a144beb146cf63e6a289ecb' => 
    array (
      0 => 'C:\\xampp\\htdocs\\cscart\\design\\backend\\templates\\views\\addons\\components\\detailed_page\\sidebar\\addon_status.tpl',
      1 => 1623227800,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '149633887560c218e83db0f8-32848356',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_60c218e841a7a2_86883878',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_60c218e841a7a2_86883878')) {function content_60c218e841a7a2_86883878($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include 'C:/xampp/htdocs/cscart/app/functions/smarty_plugins\\modifier.enum.php';
...
$_tmp7=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['submit_url'] = new Smarty_variable("addons.update_status?id=".((string)$_smarty_tpl->tpl_vars['addon']->value['addon'])."&return_url=".$_tmp7, null, 0);?>
                    <?php ob_start();?><?php echo htmlspecialchars(smarty_modifier_enum("ObjectStatuses::ACTIVE"), ENT_QUOTES, 'UTF-8');?>
<?php $_tmp8=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars(smarty_modifier_enum("ObjectStatuses::DISABLED"), ENT_QUOTES, 'UTF-8');?>
<?php $_tmp9=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/switcher.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('meta'=>"company-switch-storefront-status-button storefront__status",'checked'=>$_smarty_tpl->tpl_vars['addon']->value['status']==smarty_modifier_enum("ObjectStatuses::ACTIVE"),'extra_attrs'=>array("data-ca-submit-url"=>$_smarty_tpl->tpl_vars['submit_url']->value,"data-ca-opened-status"=>$_tmp8,"data-ca-closed-status"=>$_tmp9,"data-ca-result-ids"=>"addon_icon,addon_status")), 0);?>
